...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, is_backbone=False):
        ...
        self.conv_init = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1,
                               bias=False)
        ...
        self.fc_10 = nn.Linear(512 * block.expansion, num_classes)
...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        print('load image net pretrained model')
    return model
...
def Iresnet(pretrained=False, backbone_type=None, **kwargs):
    if backbone_type == None:
        raise BaseException("no specfic backbone type\n")
...
if __name__ == "__main__":
    model = Iresnet(pretrained=True, backbone_type='resnet18', is_backbone=False, num_classes=10).cuda()
